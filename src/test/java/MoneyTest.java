...
public class MoneyTest {
    ...
    public void test() {
        ...
        System.out.println("Fixed Tests calculateYears");
        assertEquals(3, Money.calculateYearsV2(1000,0.05,0.18,1100));
        assertEquals(14 , Money.calculateYearsV2(1000,0.01625,0.18,1200));
        assertEquals(0, Money.calculateYearsV2(1000,0.05,0.18,1000));
    }
}